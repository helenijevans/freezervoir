...
function ui(e, t, n) {
  ...
  return pt(e) ? e : C(e) ? N.object(e, t, n) : Array.isArray(e) ? N.array(e, t) : Ge(e) ? N.map(e, t) : ne(e) ? N.set(e, t) : typeof e == "object" && e !== null ? e : N.box(e, t);
}
Xr(ui, ci);
var xa = {
  box: function(t, n) {
...
function Ta(e) {
  Bt !== e.actionId_ && h(30), Bt = e.parentActionId_, e.error_ !== void 0 && (f.suppressReactionErrors = !0), an(e.prevAllowStateChanges_), st(e.prevAllowStateReads_), U(), e.runAsAction_ && ae(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && I({
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var s = this, l = arguments, c = ++is, u = Ae(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0, g = new Promise(function(m, E) {
      ...
      function H(D) {
        ...
        var se;
        try {
          se = Ae(i + " - runid: " + c + " - yield " + x++, u.next).call(u, D);
        } catch (ge) {
          return E(ge);
        }
        Qe(se);
      ...
      function Le(D) {
        ...
        var se;
        try {
          se = Ae(i + " - runid: " + c + " - yield " + x++, u.throw).call(u, D);
        } catch (ge) {
          return E(ge);
        }
        Qe(se);
    ...
    return ie(function() {
      ...
      if (!s)
        if (i.data_.size !== a.size)
          ...
          for (var D = i.data_.keys(), se = a.keys(), ge = D.next(), $n = se.next(); !ge.done; ) {
            if (ge.value !== $n.value) {
              i.keysAtom_.reportChanged();
              break;
            }
...
function pr(e) {
  return cn(e) ? e.slice() : Ge(e) || pe(e) || ne(e) || J(e) ? Array.from(e.entries()) : e;
}
...
const qn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ks = "24.5.11", Uc = "attention-required", Bc = "https://plugins.jetbrains.com/plugin/23758-vaadin", zc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Fc(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jn = globalThis, Xt = Jn.trustedTypes, Dr = Xt ? Xt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Xn = "$lit$", oe = `lit$${Math.random().toFixed(9).slice(2)}$`, Yn = "?" + oe, El = `<${Yn}>`, De = document, gt = () => De.createComment(""), bt = (e) => e === null || typeof e != "object" && typeof e != "function", Qn = Array.isArray, $i = (e) => Qn(e) || typeof e?.[Symbol.iterator] == "function", mn = `[ 	
...
const ro = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    ...
    o += a === tt ? l + El : d >= 0 ? (r.push(c), l.slice(0, d) + Xn + l.slice(d) + oe + g) : l + oe + (d === -2 ? s : g);
  }
...
const Ol = { M: Xn, P: oe, A: Yn, C: 1, L: ro, R: io, D: $i, V: Re, I: Ye, H: St, N: ao, U: so, B: oo, F: lo }, Sl = Jn.litHtmlPolyfillSupport;
...
function Cl() {
  we.push(import("./copilot-log-plugin-DJ8qpPjh.js")), we.push(import("./copilot-info-plugin-SiYwAEiO.js")), we.push(import("./copilot-features-plugin-CegWlvMe.js")), we.push(import("./copilot-feedback-plugin-CIllKoTQ.js")), we.push(import("./copilot-shortcuts-plugin-B0YVfqVx.js"));
}
function Dl() {
  {
...
}, tc = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, te = Yl(), iu = {
  toggleCopilot: `<kbd>⇧</kbd> + <kbd>${te}</kbd> <kbd>${te}</kbd>`,
  toggleCommandWindow: "<kbd>⇧</kbd> + <kbd>Space</kbd>",
  undo: `<kbd>${te}</kbd> + <kbd>Z</kbd>`,
  redo: `<kbd>${te}</kbd> + <kbd>⇧</kbd> + <kbd>Z</kbd>`,
  duplicate: `<kbd>${te}</kbd> + <kbd>D</kbd>`,
  goToSource: `<kbd>${te}</kbd> + <kbd>B</kbd>`,
  goToAttachSource: `<kbd>${te}</kbd>  + <kbd>⇧</kbd>  + <kbd>B</kbd>`,
  selectParent: "<kbd>←</kbd>",
  selectPreviousSibling: "<kbd>↑</kbd>",
  selectNextSibling: "<kbd>↓</kbd>",
  delete: "<kbd>DEL</kbd>",
  copy: `<kbd>${te}</kbd> + <kbd>C</kbd>`,
  paste: `<kbd>${te}</kbd> + <kbd>V</kbd>`
};
/**
 * @license
...
let Jr = class extends Pl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-qzpMLNUN.js"), await import("./copilot-init-step2-k_KxnTG0.js"), Vl(), Cl(), this.tabIndex = 0, Dt.hostConnectedCallback(), window.addEventListener("keydown", Br), A.onSend(this.handleSendEvent), this.removers.push(A.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
